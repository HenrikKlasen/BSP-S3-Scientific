...
As the camera object is not part of the solar system, let us assume, that the forces present in the solar system do not affect the camera. This will let us simplify the camera movement to movement with a constant velocity $v(t)$
\subsection{Assessment (0/150 words)}
