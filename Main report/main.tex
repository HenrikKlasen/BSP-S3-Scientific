...
$\begin{pmatrix}
	(f_{x} + (axis_{mj} \cdot cos(0.005 \cdot v)) \\ 0\\
	(f_{y} + (axis_{min} \cdot sin(0.005 \cdot v))
\end{pmatrix} \cdot
\begin{pmatrix}
	cos(inclination) & -sin(inclination) & 0 \\
	sin(inclination) & cos(inclination) & 0 \\
	0 & 0 & 1
\end{pmatrix} $
...
\subsubsection{Planets - Algorithmic approach and Implementation}
