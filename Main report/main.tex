...
To control the time warp factor, there is a script which controls every script dependent on time. For the planet orbit algorithm for example this would mean, that $\alpha = |\vec{v}| \cdot f$ instead of $\alpha = |\vec{v}|$
\subsection{Assessment (0/150 words)}
