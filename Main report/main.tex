...
This section will focus on the technical aspects of the scientific findings from \ref{satellite}. Next to the algorithmic approach (\ref{algorithmic-design})
