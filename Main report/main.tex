...
\begin{itemize}
	...
	\item \keys{Shift-Left} – Upwards movement relative to current rotation
	\item \keys{Ctrl-Left} – Downwards movement relative to current rotation
	\item \keys{Arrow Key Left} – Rotation Left (Z-Axis)
	\item \keys{Arrow Key Right} – Rotation Right (Z-Axis)
	\item \keys{Arrow Key Up} – Rotation Upwards (X-Axis)
	\item \keys{Arrow Key Down} – Rotation Downwards (X-Axis)
\end{itemize}
...
$$ Q = \begin{pmatrix}
	1 & 0 & 0 \\
	0 & cos(\Theta_{x}) & -sin(\Theta_{x})\\
	0 & sin(\Theta_{x}) & cos(\Theta_{x})
\end{pmatrix}+\begin{pmatrix}
	cos(\Theta_{y}) & 0 & sin(\Theta_{y}) \\
	0 & 1 & 0 \\
	-sin(\Theta_{y}) & 0 & cos(\Theta_{y})
\end{pmatrix} $$
