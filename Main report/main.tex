...
\subsection{Production (270/400 words)}
...
To control the time warp factor, there is a script which controls every script dependent on time. If we considered the whole project as a program based on the object-oriented paradigm of Model-View-Controller, then the camera script is the View, the orbits script and the satellite script are the Model and the time warp controller script is the controller. 
\subsection{Assessment (0/150 words)}
