...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{transform}: The transform attribute describes the position, rotation and the scale of the game object. To manipulate the position of the object, transform.position has to be called.
	\end{itemize}
\end{itemize}
