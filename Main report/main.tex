...
\emph{Planets}: The planets revolve around a common centre of mass. This centre of mass can be simplified to the body holding a significant amount of mass in the solar system: the sun.
\subsection{Assessment (0/150 words)}
Provide any objective elements to assess that your deliverables do or do not satisfy the requirements described above. 
