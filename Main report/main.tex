...
The rigid body class has the public attribute mass. Instead of defining it on our own, which would not have been an issue, since it is just a floating point number, we access this attribute. In doing so, it might enable more future features if needed. \\ 
The mass stored in the rigid body attribute will become the value $m_{i}$ for plugging into the formula.
