...
\subsection{Design (0/300 words)}
For finding results to the scientific subtopic, it is necessary to check the data and equations given in literature. Mainly the equations describing planet orbits and gravitation are necessary to find a way to transform these equations to the corresponding algorithms.
\subsection{Production (0/400 words)}
