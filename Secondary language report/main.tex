...
% in the abstract
\begin{abstract}
Dieses Bachelor Semester Projekt behandelt den Prozess der mathematischen Modellierung für wissenschaftliche Simulationen. Als Fallbeispiel hierfür wird eine dreidimensionale Simulation für das Sonnensystem aufgeführt. (208/800 $\rightarrow$ ca. 26\%)
\end{abstract}
...
Mit dem vierten Schritt wird das algorithmische Design angeführt. In diesem geht es darum, die Ergebnisse aus der mathematischen Modellierung in (ressourcenschonende) Algorithmen umzuwandeln. 
