...
% in the abstract
\begin{abstract}
Dieses Bachelor Semester Projekt behandelt den Prozess der mathematischen Modellierung für wissenschaftliche Simulationen. Als Fallbeispiel hierfür wird eine dreidimensionale Simulation für das Sonnensystem aufgeführt. (165/800 $\rightarrow$ ca. 21\%)
\end{abstract}
...
Der dritte Schritt in dieser Ausarbeitung dient der mathematischen Modellierung. Hierbei wird das beobachtete Verhalten mit mathematischen Formeln beschrieben, oder wenn nicht anders möglich angenähert. Es ist hierbei weiter von Vorteil, wenn 
