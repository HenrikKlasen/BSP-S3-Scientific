...
\section{ Implementation of a virtual solar system (202/800 words)}
...
\end{itemize} 
As for the technical deliverable, there is not as much literature such as official scientific papers or publications, the main source of information will be the scientific deliverable, e.g. for the equations describing the gravitational law. Next to that, the official Unity Documentation ()
...
\newblock {https://docs.unity3d.com/Manual/index.html}
