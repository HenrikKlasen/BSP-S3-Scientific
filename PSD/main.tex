...
\section{ A computational model for a solar system simulation (284/800 words)}
...
\begin{itemize}
	...
	\item \emph{What environmental factors of the solar system have to be considered?}: This question aims on answering, \emph{how} the model will look like, what simplifications there are and which approaches are taken.
\end{itemize}
