...
\section{ Implementation of a virtual solar system (354/800 words)}
...
As the user will be able to control the camera, they will be required to input the directions on the keyboard. The Keyboard buttons will be mapped as follows:
\begin{itemize}
...
Also the  satellite will be controllable by the user. As of the point of time of writing this Project subject Description, it is not yet determined which keys will be mapped to which movement. 
