...
\section{ A computational model for a solar system simulation (568/800 words)}
...
These resources will provide a load of information for finding good answers to the scientific question. This will allow us to develop a simplified model of the solar system in the technical part.
