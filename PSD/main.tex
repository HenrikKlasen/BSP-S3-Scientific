...
\section{ A computational model for a solar system simulation (295/800 words)}
...
\begin{itemize}
	\item \cite{PhysicsSimulationsLargeWorlds}
\end{itemize}
