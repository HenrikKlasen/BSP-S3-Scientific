...
\section{ Implementation of a virtual solar system (36/800 words)}
...
While the scientific part is more about the "\emph{What do we want to simulate?}", this part is more about the "\emph{How do we implement what we want to simulate?}" 
