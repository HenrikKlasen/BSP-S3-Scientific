...
\section{ A computational model for a solar system simulation (664/800 words)}
...
\section{ Implementation of a virtual solar system (439/800 words)}
...
\end{itemize}
As the simulation will include a camera, it will be necessary to include a Graphical user interface and a keyboard interaction interface for controlling the camera. The Keyboard controls will be using for WASD control for horizontal translational movement, XY control for vertical translational movement and Arrow Key controls for rotations around X and Z axis. \\
The Graphical user interface will contain information about the distance from the sun, the velocity of the camera, as well as the distance of the satellite from the sun.
