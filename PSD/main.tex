...
\section{ A computational model for a solar system simulation (410/800 words)}
...
\begin{itemize}
	...
	\item \emph{Scientific Computing}: Scientific Computing is an interdisciplinary discipline bound to develop approaches for algorithms, models and software for simulating real world behaviour as close as possible. It is the main 
\end{itemize}
